...
<p align="center">
<img src="images/gpt.jpg" width="200" height="200">
<b><u><p align="center"><font
					face="Arial,helvetica,verdana,geneva" size="5"> <font
			color="#0000FF">LIST OF ATTENDANCE OF FACULTY BETWEEN DATE1 TO DATE 2</font></font></p></u></b>
<p align="center">
                        <input type="hidden" name="type" value="view" />
                        <font
					face="Arial,helvetica,verdana,geneva" size="5"> <font
			color="#0000FF">DATE1:</font></font> <input type="text" class="validate[required]" readonly value='<?php echo $data['startDate']; ?>' name="startDate" id="startDate" />
                         <font
					face="Arial,helvetica,verdana,geneva" size="5"> <font
			color="#0000FF">DATE2:</font></font><input type="text" class="validate[required]" readonly value='<?php echo $data['endDate']; ?>' name="endDate" id="endDate" />
